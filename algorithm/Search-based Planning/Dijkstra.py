'''
Dijkstra: minest explore_base first to explore neighbors with new_cost, which check whether to optima neighbor's explore_tree and explore_base, until find the goal
'''
